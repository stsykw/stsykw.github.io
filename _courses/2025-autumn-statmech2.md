...
**11月19日**  
理想ボース気体: 絶対零度近傍の性質とボース-アインシュタイン凝縮、圧力とエネルギー・比熱  
...
フェルミエネルギーの表式を導出せよ。
同様に、一辺\\( L \\)の正方形に閉じ込められた二次元自由粒子についても、エネルギー状態密度およびフェルミエネルギーの表式を導出せよ。

**Quiz 5(11月19日出題)**  
2次元に閉じこめられた理想ボース気体では、有限温度でボース-アインシュタイン凝縮が起きないことを、3次元の時の議論を参考に議論せよ。

**Quiz 6(12月3日出題)**  
凝縮相\\( ( T< T_c ) \\)において、励起状態を取っている粒子一つあたりのエントロピーを求めよ。


**Quiz 7(12月24日出題)**  
Lennard-Jones相互作用する単原子分子気体について、近似を行った結果、分配関数は
$$
\begin{equation}
Z_N = Z_N^{(id)} \dfrac{(V-Nv_0)^N}{V^N} \exp N \beta \epsilon \rho v_0
\end{equation}
$$
