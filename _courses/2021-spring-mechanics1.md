...
**6月28日(オンライン)**  
振り子の運動: 有限振幅の運動  
角運動量とその保存: 角運動量、中心力、面積速度  

**7月5日(オンライン)**  
惑星の運動：万有引力の法則、Keplerの三つの法則、エネルギー保存則    
...
\end{equation}
$$
という中心力になるため、全角運動量が保存し運動は2次元平面内に限られる。2次元極座標をとり、\\( r^2 \dfrac{d\phi}{dt}\\)は定数\\( h\\)にとることができる。
万有引力の時と同様に解析し以下の問に答えよ。
